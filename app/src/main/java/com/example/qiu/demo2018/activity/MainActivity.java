    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.fragment5:
                ...
                break;
            case R.id.fragment6:
                getFragmentManager().beginTransaction().replace(R.id.liner_view,new Fragment6()).addToBackStack(null).commit();
                break;
            case R.id.fragment7:
                getFragmentManager().beginTransaction().replace(R.id.liner_view,new Fragment7()).addToBackStack(null).commit();
                break;
            case R.id.fragment8:
                getFragmentManager().beginTransaction().replace(R.id.liner_view,new Fragment8()).addToBackStack(null).commit();
                break;
